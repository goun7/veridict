...
| **Phase 3 — Platform + Standard** | Watcher marketplace; hosted enterprise layer; **spec v1.0 standard publication**; community governance; formal verification of the core (ladder: done 2026-09, proofs/ladder + proofs.yml CI; ledger/anchor: open) | ① A third party implements an independent verifier from the spec ② First external production deployment ③ ≥10 active watcher manifests |
