...
| **Crypto donations** (multi-chain: Solana + EVM + BTC + Sui LIVE in FUNDING.yml; TRC-20 follows 2026-09-12 via TronLink — receive-only addresses, no signing authority) | $0 | LIVE (decision 2026-09-10, activated 2026-09-11/12 night) | Global donors pick their cheapest rail; no custody, no payout setup, no tax-setup friction. Honest note: the tax character of income does not change with the rail — declaration goes through a professional once amounts matter |
